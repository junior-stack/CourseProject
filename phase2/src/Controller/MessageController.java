...
public class MessageController {
  ...
  /**
   * This method sends the message to the target user email from current user, the method is for
   * attendee.
   *
   * @param targetEmail The email address of the target user.
   * @param content     The content of the message.
  ...
  /**
   * This method sends message to a group of people who sign up for the events specified in
   * eventIds.
   *
