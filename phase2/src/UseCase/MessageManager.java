...
public class MessageManager {
  ...
  /**
   * This method is to send multiple messages at the same time from senderEmail to all
   * receiverEmails with content.
   *
   * @param senderEmail    This represents the sender email address.
   * @param receiverEmails This represents a list of all receiver email addresses.
   * @param content        This represents the content of the message.
   */
  public void multipleMessageRequest(String senderEmail, List<String> receiverEmails,
      String content) {
  ...
  /**
   * This method is to generate all emails of attendees of certain events for a speaker to send
   * messages.
   *
