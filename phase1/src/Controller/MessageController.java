...
public class MessageController {
    ...
    private Map<String, String> emailToIdentity = new HashMap<>();
    ...
    public boolean attendeeOrganizerSingleMessage(String email, String message){
        if (emailToIdentity.get(email).equals("Attendee") || emailToIdentity.get(email).equals("Speaker")){
    ...
    public boolean organizerMultipleMessage(String targetIdentity, String message){
        if (targetIdentity.equals("Organizer")){return false;}
